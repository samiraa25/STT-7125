...
On observe davantage d’hommes que de femmes. La proportion d'infection est très similaire entre les sexes, avec une légère tendance à être plus faible chez les Femmes par rapport aux Hommes.<br>

Enfin, il y a beaucoup plus de nageurs entre 15 et 19 ans. Les jeunes de 25 à 29 ans sont les moins nombreux des 3 catégories. De plus, il n'y a pas de différence notable dans la proportion d'infection à travers les trois catégories d'âge, on peut se douter que l'âge pourrait ne pas être significatif.
```{r stat1}
summary(earinf)
graph1 ; graph2
```
